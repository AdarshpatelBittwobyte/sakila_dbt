...
app.post('/signups', async (req, res) => {
 ...
 // Master login authentication route
app.post('/masterlogin', async (req, res) => {
 ...
 // Teacher Login authentication route
 ...
 //  Student Login authentication route
...
app.get('/api/studentTimetable', async (req, res) => {
  try {
    ...
    // Fetch all students from the students table
    const studentsSql = `select * from  B2B_STUDENT_TIME_TABLE`;
...
app.listen(2081, () => {
  console.log(`Server is listening on port 2081`);
});