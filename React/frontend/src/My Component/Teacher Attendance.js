...
const TeacherAttendance = ({ title }) => {
    ...
    const fetchStudentAcademic = async () => {
      try {
        const response = await axios.get('http://localhost:8001/api/staffAttendance');
    ...
    // Add filterData to the dependency array
      ...
      <div className="header-container" style={{ fontFamily: 'Arial, sans-serif' }}>
        ...
        <div className="container-fluid header-container" style={{ width: '100%', marginTop: '13vh', padding: 0 }}>
          <div className="container-fluid d-flex flex-column" style={{ minHeight: '100vh' }}>
            <div className="p-2 mb-2 d-flex justify-content-between align-items-center" style={{ backgroundColor: '#34495E', fontFamily: 'Arial, sans-serif' }}>
              <h1 style={{ fontSize: '1.5rem', backgroundColor: '#34495E', color: '#FFFFFF' }}>Teacher Attendance</h1>
            </div>
